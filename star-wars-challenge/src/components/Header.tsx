    ...
    <header className="sticky top-0 z-20 border-b bg-neutral-950/80 backdrop-blur">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3">
        ...
        <nav className="flex items-center gap-2">
          <Link
            className={`rounded-lg px-3 py-1.5 text-sm hover:bg-neutral-800 ${
          ...
          <Link
            className={`rounded-lg px-3 py-1.5 text-sm hover:bg-neutral-800 ${pathname === "/team" ? "bg-neutral-800" : ""}`}
            to="/team"
          >
            Team
          </Link>
