...
export const TeamButtons: React.FC<TeamButtonsProps> = ({ character }) => {
    ...
    function handleAdd() {
        ...
        if (teamFull) return showMsg("Your team is full (max 5). Remove someone first.");
    ...
    return (
        <div className="mb-6 space-y-2">
            ...
            {msg && <p className="text-sm text-gray-400 text-center transition-opacity">{msg}</p>}
        </div>
    );
};
